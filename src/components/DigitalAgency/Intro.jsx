    ...
    <section className="about section-padding main-bg">
      <div className="container ontop">
        <div className="row justify-content-between">
          ...
          <div className="col-lg-6 overflow-hidden valign">
            <div className="cont sec-lg-head">
              <h1 className="dot-titl mb-20">Training Agency</h1>
                ...
                <div className="col-lg-12">
                  <div className="text mt-20">
                    <p>
                      ...
                      on searching new ways to showcase user content on digital
                      support and envisioning the future arts.
                    </p>
                  </div>
                  <div className="underline">
                    <Link href={"/aboutus"} className="mt-30 ls1 sub-title">
                      Read More
                      <i className="ml-5">
                        <svg
                          width="18"
        ...
        <div className="row md-marg mt-100 justify-content-center">
          <div className="col-lg-4 col-md-6 ">
            <div
              className="item-serv md-mb50 p-3"
            ...
            >
              ...
              <div className="d-flex flex-column align-items-center">
                <p className="fz-14">
                  Creating user interfaces for seamless, interactive web
                  experiences.
                </p>
                <button className="butn butn-md butn-bg main-colorbg2 radius-30 mt-30">
                  <span onClick={toggle}>Registr now</span>
                </button>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-6">
            ...
            >
              ...
              <div className="d-flex flex-column align-items-center">
                <p className="fz-14">
                  Building server-side logic to ensure functionality and data
                  management.
                </p>
                <button className="butn butn-md butn-bg main-colorbg2 radius-30 mt-30">
                  <span onClick={toggle}>Registr now</span>
                ...
                <div className="mr-30">
                  <div className="icon-img-50">
                    <Image
                      width={500}
                      height={500}
                      src={`/${"dark"}/assets/imgs/serv-icons/2.png`}
                      alt="2.png"
                    />
                  </div>
                </div>
